...
import io.github.stoneream.dachshund.service.application.user_new_release_notification_delivery_queue.{UserNewReleaseNotificationDeliveryQueueService, UserNewReleaseNotificationDeliveryQueueServiceImpl}
...
class DaemonModule(
  ...
  override def configure(): Unit = {
    ...
    bind(classOf[UserNewReleaseNotificationDeliveryQueueService]).to(classOf[UserNewReleaseNotificationDeliveryQueueServiceImpl])
  ...
  @Provides
  @Singleton
  def provideUserNewReleaseNotificationDeliveryQueueJobConfig(daemonConfig: DaemonConfig): UserNewReleaseNotificationDeliveryQueueJobConfig =
    daemonConfig.jobs.userNewReleaseNotificationDeliveryQueue
}
