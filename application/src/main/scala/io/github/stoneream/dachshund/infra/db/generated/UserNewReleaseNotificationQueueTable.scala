...
object UserNewReleaseNotificationQueueTable {
  val Name = "user_new_release_notification_queue"
  ...
  def map(rs: WrappedResultSet): UserNewReleaseNotificationQueueDbRow =
