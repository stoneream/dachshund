...
object UserNewReleaseNotificationDeliveryJobStatusReader {
...
@Singleton
class UserNewReleaseNotificationDeliveryJobStatusReader @Inject() () {
  import UserNewReleaseNotificationDeliveryJobStatusReader.{QueueRow, StatusCount}
