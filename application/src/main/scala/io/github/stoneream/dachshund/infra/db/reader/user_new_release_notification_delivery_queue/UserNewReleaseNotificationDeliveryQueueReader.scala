package io.github.stoneream.dachshund.infra.db.reader.user_new_release_notification_delivery_queue

import io.github.stoneream.dachshund.infra.db.AuditUser
import io.github.stoneream.dachshund.infra.db.ex.UserNewReleaseNotificationDeliveryQueueSource
...
object UserNewReleaseNotificationDeliveryQueueReader {
  final case class QueueTarget(
      queue: UserNewReleaseNotificationDeliveryQueueSource,
      userId: Long,
...
@Singleton
class UserNewReleaseNotificationDeliveryQueueReader @Inject() () {
  import UserNewReleaseNotificationDeliveryQueueReader.{ClaimResult, QueueTarget}
