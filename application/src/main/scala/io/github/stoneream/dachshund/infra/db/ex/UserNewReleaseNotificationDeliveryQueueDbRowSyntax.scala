...
object UserNewReleaseNotificationDeliveryQueueDbRowSyntax {

  extension (source: UserNewReleaseNotificationDeliveryQueueSource) {
    def toUserNewReleaseNotificationDeliveryQueueDbRow: UserNewReleaseNotificationDeliveryQueueDbRow = {
      import DbRowValues.*
