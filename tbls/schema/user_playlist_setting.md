...
CREATE TABLE `user_playlist_setting` (
  ...
  `playlist_usage_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NEW_RELEASE_NOTIFICATION' COMMENT 'プレイリスト用途種別(NEW_RELEASE_NOTIFICATION)',
  `spotify_playlist_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'SpotifyプレイリストID',
  `spotify_playlist_uri` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'SpotifyプレイリストURI',
  `playlist_name` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'プレイリスト名',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  UNIQUE KEY `uq_user_playlist_setting_user_usage` (`user_id`,`playlist_usage_type`),
  KEY `idx_user_playlist_setting_user_enabled` (`user_id`,`deleted`,`enabled`),
  CONSTRAINT `fk_user_playlist_setting_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ユーザープレイリスト設定'
```
...
| playlist_usage_type | varchar(255) | NEW_RELEASE_NOTIFICATION | false |  |  |  | プレイリスト用途種別(NEW_RELEASE_NOTIFICATION) |
| spotify_playlist_code | varchar(255) |  | false |  |  |  | SpotifyプレイリストID |
| spotify_playlist_uri | varchar(255) |  | false |  |  |  | SpotifyプレイリストURI |
| playlist_name | varchar(512) |  | false |  |  |  | プレイリスト名 |
...
| ---- | ---- | ---------- |
| fk_user_playlist_setting_user_id | FOREIGN KEY | FOREIGN KEY (user_id) REFERENCES user (id) |
| id | UNIQUE | UNIQUE KEY id (id) |
| PRIMARY | PRIMARY KEY | PRIMARY KEY (id) |
| uq_user_playlist_setting_user_usage | UNIQUE | UNIQUE KEY uq_user_playlist_setting_user_usage (user_id, playlist_usage_type) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| idx_user_playlist_setting_user_enabled | KEY idx_user_playlist_setting_user_enabled (user_id, deleted, enabled) USING BTREE |
| PRIMARY | PRIMARY KEY (id) USING BTREE |
| id | UNIQUE KEY id (id) USING BTREE |
| uq_user_playlist_setting_user_usage | UNIQUE KEY uq_user_playlist_setting_user_usage (user_id, playlist_usage_type) USING BTREE |
