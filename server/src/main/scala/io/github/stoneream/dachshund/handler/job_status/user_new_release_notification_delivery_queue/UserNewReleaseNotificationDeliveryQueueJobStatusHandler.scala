package io.github.stoneream.dachshund.handler.job_status.user_new_release_notification_delivery_queue
...
import io.github.stoneream.dachshund.usecase.job_status.user_new_release_notification_delivery_queue.{UserNewReleaseNotificationDeliveryQueueJobStatusUseCase, UserNewReleaseNotificationDeliveryQueueJobStatusUseCaseOutput}
import play.api.mvc.{AnyContent, Result}

import scala.concurrent.{ExecutionContext, Future}

@Singleton
class UserNewReleaseNotificationDeliveryQueueJobStatusHandler @Inject() (
    override val useCase: UserNewReleaseNotificationDeliveryQueueJobStatusUseCase,
  ...
  override def renderer: HtmlRendererBase[UserNewReleaseNotificationDeliveryQueueJobStatusUseCaseOutput, JobStatusDetailUseCaseException, Result] =
